...
The website for **ARHAFEZ**, the strategic brand practice of Abdulrhman Hafez.
...
`react-router-dom`, `clsx`, `tailwind-merge`, `tailwindcss-animate`.
...
├─ data/projects.ts        Case-study content + contact/social constants
